...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double X_MULTIPLIER = 0.98742228; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 1.00898593; // Multiplier in the Y direction
    ...
    public StandardTrackingWheelLocalizer(HardwareMap hardwareMap) {
        super(Arrays.asList(
                ...
                new Pose2d(FORWARD_OFFSET, 1.5, Math.toRadians(90)) // front
        ));
